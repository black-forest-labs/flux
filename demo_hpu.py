...
# Ensure that Habana SynapseAI is available
try:
    import habana_frameworks.torch.core as htcore
    from habana_frameworks.torch.hpu import lazy_mode
except ImportError:
    st.error("Habana SynapseAI library is not installed. Please install it to use HPU.")
...
def main(
    ...
    if device == "hpu":
        # Ensure lazy mode is enabled for Habana devices
        lazy_mode(True)
